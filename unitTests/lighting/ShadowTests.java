...
public class ShadowTests {
   ...
   private void sphereTriangleHelper(String pictName, Triangle triangle, Point spotLocation) {
      ...
      Camera cam1 = camera.setImageWriter(new ImageWriter(pictName, 400, 400))
              .build();
      cam1.renderImage();//
      cam1.writeToImage();
   }
   ...
   public void sphereTriangleMove1() {
      sphereTriangleHelper("shadowSphereTriangleMove1", //
                           new Triangle(new Point(-55,-23,-25), new Point(-25, -53, -25), new Point(-53, -51, -29)), //
                           new Point(-100, -100, 200));
   }
   ...
   public void trianglesSphere() {
      ...
      Camera cam2=camera.setImageWriter(new ImageWriter("shadowTrianglesSphere", 600, 600))
         .build();
         cam2.renderImage();
         cam2.writeToImage();
   }
